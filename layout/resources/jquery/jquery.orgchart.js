 ...
 */
 (function($) {
    ...
    function buildNode($node, $appendTo, level, index, opts) {
        ...
        var $heading = $("<div class='w-100 h-100'>").html(opts.nodeText($node));
        var $nodeDiv = $("<div class='row-box'>")
                        .addClass("node").addClass("level"+level)
                        .addClass("node"+index).addClass("level"+level+"-node"+index)
